      ...
      <div className="bg-gradient-to-r from-brand-600 to-brand-800 text-white p-8 rounded-b-[3rem] shadow-xl mb-8 relative overflow-hidden">
         ...
         <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
               <h2 className="text-4xl font-black uppercase tracking-tight mb-2">ENGLISH MRS. DUNG</h2>
               <p className="text-brand-100 font-bold opacity-90">English with Heart - Success with Mrs.Dung</p>
            ...
            <div className="flex flex-col items-center md:items-end gap-2 bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
               <span className="text-sm">📞 Zalo/Phone: 0364409436</span>
               <a href="https://www.facebook.com/profile.php?id=100054264771359" target="_blank" className="text-sm underline hover:text-brand-200">Facebook Mrs. Dung</a>
            </div>
         </div>
      </div>
          ...
          {data && (
            <div className="animate-fade-in flex flex-col items-center">
               <div ref={canvasRef} className="bg-white p-10 rounded-[3rem] shadow-2xl border-[15px] border-slate-50 relative overflow-hidden w-full max-w-[1000px] aspect-[4/3] flex flex-col items-center justify-center">
                  <div className="absolute top-10 right-10 text-brand-600 font-black text-sm uppercase opacity-30">ENGLISH MRS. DUNG</div>
