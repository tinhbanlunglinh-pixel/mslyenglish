        ...
        {!state.contentResult && !state.isLoading && !isConfiguring && (
          <div className="space-y-12 animate-fade-in max-w-5xl mx-auto">
            <div className="text-center mb-10">
                ...
                <p className="text-slate-500 text-lg">Chọn nhân vật yêu thích và kể cho Mrs. Dung nghe cuộc phiêu lưu!</p>
            </div>
               ...
               <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea 
                            placeholder="Ví dụ: Kể về tình bạn, làm câu chuyện hài hước..."
          ...
          <div className="mt-20 text-center space-y-8 animate-fade-in">
            ...
            <div>
                ...
                <p className="text-slate-500 text-lg font-bold">
                    Mrs. Dung AI đang chuẩn bị câu chuyện cho con...
                </p>
            </div>
          </div>
        )}
